...
const portfolioItems = [
  ...
  { label: "Обработка стоп", beforeImage: "https://cdn.poehali.dev/projects/756bf854-deba-40d9-ab92-127a45ee7a4b/bucket/9cbabebd-f272-47ae-ae02-e2b0625180bb.jpg", afterImage: "https://cdn.poehali.dev/projects/756bf854-deba-40d9-ab92-127a45ee7a4b/bucket/cfa73aa6-df21-41f6-8b2a-926d727f9e26.jpg" },
];
...
const reviews = [
  {
    name: "Марина К.",
    date: "Март 2024",
    text: "Эльвира — настоящий профессионал! Пришла с запущенным грибком, ногти выглядят здоровыми. Очень деликатный подход и стерильность на высшем уровне.",
    stars: 5,
